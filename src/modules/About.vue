            ...
            <section>
                <ul>
                    <li>
                        <div class="year">
                            <span></span>
                            <img :src="img.yearPoint" alt=""/>
                            <p>2015</p>
                        </div>
                        <div>
                            <span>10月09日</span>
                            <img :src="img.dayPoint" alt=""/>
                            <p>迅鳐成都科技有限公司成立</p>
                        </div>
                        <div>
                            <span>12月</span>
        ...
        <div class="partner">
            ...
            <section>
                <ul>
                    ...
                    <li><img :src="img.partner9" alt=""/></li>
                </ul>
            </section>
        </div>
    </div>
...
<style lang="scss" scoped>
    ...
    .events{
        section{
            padding: 20px 40px;
            background: url(imgUrl('timeline.png')) no-repeat 192px center;
            background-size: 2px;
            ul{
                li{
                    div{
